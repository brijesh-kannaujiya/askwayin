                ...
                <!--<div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    <div class="nav-menus-wrapper" style="transition-property: none;">
                      <ul class="nav-menu nav-menu-social align-to-right">
                         ...
                         <li>
                          <a href="{{ route('front.page','we-are-hiring') }}"><i class="ri-briefcase-line"></i> We are Hiring</a>
                        </li>
                        <li>
                          <a href="{{ route('front.page','advertise_with_us') }}"><i class="ri-advertisement-line"></i> Advertise</a>
                        </li>  
                        ...
                        <li>
                          ...
                          <li>
                          <a href="{{ route('user.login') }}" class="ft-bold"><i class="ri-login-box-line"></i> Login / Sign Up </a>
                        </li>
                        <li class="add-listing">
                          <a href="{{ route('user.listing.type') }}">
                            <i class="fas fa-plus me-2"></i>Free Listing </a>
                        </li>
                        @endauth
                      </ul>
                    </div>
