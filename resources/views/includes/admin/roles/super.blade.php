    ...
    <li class="nav-item">
        ...
        <div id="manage_appads" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.appadds.index') }}">{{ __('All Appadds') }}</a>
                <a class="collapse-item" href="{{ route('admin.appadds.create') }}">{{ __('Create Appadds') }}</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.SubscriberUser.index') }}">
            <i class="fas fa-user"></i>
            <span>{{ __('Manage Subscriber') }}</span>
        </a>
    </li>
        ...
        <div id="homepage" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.partner.index') }}">{{ __('Partner Section') }}</a>
                 <a class="collapse-item" href="{{ route('admin.bartner.index') }}">{{ __('Advertisement Banner') }}</a>
                  <a class="collapse-item" href="{{ route('admin.sartner.index') }}">{{ __('Small Banner') }}</a>
