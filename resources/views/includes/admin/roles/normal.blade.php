...
@if(Auth::guard('admin')->user()->sectionCheck('Manage Ads'))
<li class="nav-item">
    ...
    <div id="manage_ads" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar1">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ route('admin.plans.index') }}">{{ __('All Ads') }}</a>
            <a class="collapse-item" href="{{ route('admin.plans.create') }}">{{ __('Create Ads') }}</a>
        </div>
    </div>
</li>
@endif
...
@if(Auth::guard('admin')->user()->sectionCheck('Manage App Adds'))
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#manage_apppads" aria-expanded="true" aria-controls="collapseTable">
        <i class="fab fa-telegram-plane"></i>
        <span>{{  __('Manage App Adds') }}</span>
    </a>
    <div id="manage_apppads" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar1">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ route('admin.appadds.index') }}">{{ __('All App Adds') }}</a>
            <a class="collapse-item" href="{{ route('admin.appadds.create') }}">{{ __('Create App Adds') }}</a>
        </div>
    </div>
</li>
@endif
...
@if(Auth::guard('admin')->user()->sectionCheck('Foodtype'))
<li class="nav-item">
    <a class="nav-link" href="{{ route('admin.foodtype.index') }}">
        <i class="fas fa-clinic-medical"></i>
        <span>{{ __('Foodtype') }}</span>
    </a>
</li>
@endif
...
@if(Auth::guard('admin')->user()->sectionCheck('Manage Users'))
<li class="nav-item">
...
@if(Auth::guard('admin')->user()->sectionCheck('Manage Subscribers'))
<li class="nav-item">
    <a class="nav-link" href="{{ route('admin.SubscriberUser.index') }}">
        <i class="fas fa-user"></i>
        <span>{{ __('Manage Subscribers') }}</span>
    </a>
</li>
@endif
...
@if(Auth::guard('admin')->user()->sectionCheck('Home Banner'))
<li class="nav-item">
    <a class="nav-link" href="{{ route('admin.transactions.index') }}">
        <i class="fas fa-chart-line"></i>
        <span>{{ __('Home Banner') }}</span>
    </a>
</li>
@endif
