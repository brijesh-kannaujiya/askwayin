...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between">
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Partner') }} <a class="btn btn-primary btn-rounded btn-sm"
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.partner.store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="brand_name_arbic" name="brand_name_arbic" value=""
              placeholder="{{ __('Brand Name') }}" required>
          </div>

          <div class="form-group">
            <label for="title">{{ __('Brand Url') }}</label>
            <input type="text" class="form-control" id="brand_url" name="brand_url" value=""
            ...
            <div class="wrapper-image-preview">
              <div class="box">
                ...
                <div class="upload-options">
                  <label class="img-upload-label" for="img-upload"> <i class="fas fa-camera"></i> {{ __('Brand App
                    Icon') }} </label>
