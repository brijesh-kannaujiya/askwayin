      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.partner.store')}}" method="POST" enctype="multipart/form-data">
            ...
            {{ csrf_field() }}
                ...
                <input type="text" class="form-control" id="brand_name" name="brand_name" value=""  placeholder="{{ __('Brand Name') }}" required>
            </div>
            
             <div class="form-group">
                <label for="title">{{ __('Brand Url') }}</label>
                <input type="text" class="form-control" id="brand_url" name="brand_url" value=""  placeholder="{{ __('Brand Url') }}" required>
            </div>
                ...
                <div class="wrapper-image-preview">
                    <div class="box">
                        ...
                        <div class="upload-options">
                            <label class="img-upload-label" for="img-upload"> <i class="fas fa-camera"></i> {{ __('Brand App Icon') }} </label>
