...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between">
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Edit Appadds') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.appadds.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
    <ol class="breadcrumb">
  ...
  <div class="col-md-10">
    <div class="card mb-4">
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Appadds Form') }}</h6>
      </div>

      <div class="card-body">
        <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
        <form class="geniusform" action="{{route('admin.appadds.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group d-none">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{$data->name}}"  placeholder="{{ __('Adds Name') }}">
            </div>
            ...
            @endforeach
             ...
             <div class="form-group">
                ...
                <input type="text" class="form-control" id="appadds_url" name="appadds_url" value="{{$data->appadds_url}}"  placeholder="{{ __('Adds Url') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="wrapper-image-preview">
                    <div class="box">
                        <div class="back-preview-image" style="background-image: url({{$data->appadds_img ? asset('assets/images/'.$data->appadds_img) : asset('assets/images/placeholder.jpg') }});"></div>
