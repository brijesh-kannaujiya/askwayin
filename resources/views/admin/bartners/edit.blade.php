...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between">
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Edit Home Banner') }} <a class="btn btn-primary btn-rounded btn-sm"
  ...
  <div class="col-md-10">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.bartner.update',$data->id)}}" method="POST"
