                        ...
                        <div id="tabs">
                            ...
                            <div class="tab-content">
                                <div id="basic" class="container tab-pane active"><br>
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-lg-9">-->
                                    <!--        <input type="text" class="input-field" id="latitude" name="latitude"  placeholder="{{ __('Latitude') }}" value="" readonly>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-lg-9">-->
                                    <!--        <input type="text" class="input-field" id="longitude" name="longitude"  placeholder="{{ __('Longitude') }}" value="" readonly>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="left-area">
                                                <h4 class="heading">{{ __('Food Type') }} *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="left-area">
                                                <h4 class="heading">{{ __('Highlights') }} *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                            <select id="highlight_type" name="highlight_type" class="input-field">
                                                <option value="Tranding">{{__('Tranding')}}</option>
                                                <option value="Popular">{{__('Popular')}}</option>
                                                <option value="Verified">{{__('Verified')}}</option>
                                                <option value="Trusted">{{__('Trusted')}}</option>
                                                <option value="Top-rated">{{__('Top-rated')}}</option>
                                                <option value="Ads">{{__('Ads')}}</option>
                                                <option value="Deals">{{__('Deals')}}</option>
                                            </select>
                                        </div>
                                    </div>
