      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.categories.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="wrapper-image-preview">
                    <div class="box">
                        <div class="back-preview-image" style="background-image: url({{$data->photo1 ? asset('assets/images/'.$data->photo1) : asset('assets/images/placeholder.jpg') }});"></div>
                        <div class="upload-options">
            ...
            <div class="form-group">
                ...
                <div class="wrapper-image-preview">
                    <div class="box">
                        <div class="back-preview-image" style="background-image: url({{$data->photo_banner ? asset('assets/images/'.$data->photo_banner) : asset('assets/images/placeholder.jpg') }});"></div>
                        <div class="upload-options">
            ...
            <div class="form-group">
                ...
                <div class="wrapper-image-preview">
                    <div class="box">
                        <div class="back-preview-image" style="background-image: url({{$data->photo3 ? asset('assets/images/'.$data->photo3) : asset('assets/images/placeholder.jpg') }});"></div>
                        <div class="upload-options">
                            <label class="img-upload-label" for="img-upload3"> <i class="fas fa-camera"></i> {{ __('Upload Picture') }} </label>
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" name="pop_cat" class="form-check-input" value="1" id="pop_cat" {{ $data->pop_cat == 1 ? 'checked' : ''}}>
                    <label class="form-check-label" for="pop_cat">{{ __('Check if this category is Popular') }}</label>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="pop_home_cat">{{ __('Check if Home category is Popular') }}</label>
                </div>
            </div>
