            ...
            <div class="card-body">
                ...
                <form class="geniusform" action="{{route('admin.categories.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inp-name" name="title_arbic" placeholder="{{ __('Enter Name') }}" value="" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="wrapper-image-preview">
                            <div class="box">
                                <div class="back-preview-image" style="background-image: url({{asset('assets/images/placeholder.jpg') }});">
                                </div>
                                <div class="upload-options">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" name="is_mobile_text" class="form-check-input" value="1" id="is_mobile_text">
