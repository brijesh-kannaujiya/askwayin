            ...
            <div class="card-body">
                ...
                <form class="geniusform" action="{{route('admin.categories.store')}}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inp-slug" name="mobile_center_text"
                            placeholder="{{ __('Enter Mobile Center text') }}" required>
                    </div>
                    <div class="form-group">
                        <label for="inp-slug">{{ __('Mobile Center text Arbic') }}</label>
                        <input type="text" class="form-control" id="inp-slug" name="mobile_center_text_ar"
                            placeholder="{{ __('Enter Mobile Center text Arbic') }}" required>
                    </div>
                            ...
                            <div class="box">
                                ...
                                <div class="upload-options">
                                    <label class="img-upload-label" for="img-upload5"> <i class="fas fa-camera"></i> {{
                                        __('Upload Picture') }} </label>
                                    <input id="img-upload5" type="file" class="image-upload" name="photo5"
                                        accept="image/*">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" name="is_mobile_text" class="form-check-input" value="1"
                                id="is_mobile_text">
