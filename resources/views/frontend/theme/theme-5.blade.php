...
<div class="home-banner margin-bottom-0" style="background:#01a1a1 url({{ asset('assets/images/'.$ps->hero_photo) }}) no-repeat;"  data-overlay="1">
  <div class="container">
    	...
    	<div class="col-md-12">
	    	<div class="flex-service" style="max-width: max-content;">
	    		...
	    		<div class="list">
	    		    ...
	    		    <a href="{{ route('front.listing',['category'=>[$category->slug]]) }}">
	    		        
	    		    <?php }else{ ?>   
	    		    <a href="{{ route('front.subcat',['slug' => $category->slug]) }}">
	    		        <?php } ?>
	    		    <img src="{{ asset('assets/images') }}/{{ $category->photo }}"><p>@lang($category->title)</p></a>
    </div>
	    		@endforeach
	    		@endif
...
<section class="ad-banner space pt-0">
	<div class="container">
			...
			<div class="col-md-12 text-end">
		            <a href="{{ route('front.page','advertise_with_us') }}" class="btn btn-success rounded adver-btn mb-1">@lang('Advertise Here')</a>
				<div class="offers">
<?php 
...
@if ($bigbanner)
@foreach ($bigbanner as $key => $bigbanner_data)
 <div><a href="#"><img src="{{ asset('assets/images') }}/{{ $bigbanner_data->photo }}"></a></div>
...
@if ($smallbanner)
@foreach ($smallbanner as $key => $smallbanner_data)

	<div class="col-md-3 col-6">
				<div class="flex-four">
					<div><a href="{{ $smallbanner_data->url }}">
						<div class="box-text text-white">
							<h3 class="fw-bold">@lang($smallbanner_data->title)</h3>
							<p> @lang($smallbanner_data->subtitle)</p>
						</div>
						<img src="{{ asset('assets/images') }}/{{ $smallbanner_data->photo }}" class="img-fluid">
					</a></div>
				 
				</div>
			</div>
			
              <!--<div><a href="{{ $smallbanner_data->url }}"><img src="{{ asset('assets/images') }}/{{ $smallbanner_data->photo }}" class="img-fluid"></a>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading d-flex-between mb-4">
					<h1 class="fw-bold heading">@lang('Popular Category')</h1>
				</div>
			</div>
		</div>
...
?>
  <div class="col-md-6 mb-3">
		        <div class="box-border">
		            <div class="row">
		                <div class="col-md-12">
		                    <h4 class="fw-bold">@lang($popularcat_data->title)</h4>
		                </div>
		            </div>
		            <div class="row">
<?php 
...
?>
  ...
  @if ($popularsubcat)
 @foreach ($popularsubcat as $key => $popularsubcat_data)

		                <div class="col-md-4 col-4">
		                    <div class="catbox text-center">
		                        <a href="{{ route('front.listing',['category' => [$popularsubcat_data->slug]]) }}">
		                            <img src="{{ asset('assets/images') }}/{{ $popularsubcat_data->photo1 }}" class="img-fluid" />
		                            <h6 class="mt-3">@lang($popularsubcat_data->title)</h6>
		                        </a>
		                    </div>
		                </div>
		@endforeach
		...
		<div class="row">
			<div class="col-md-12">
				<div class="heading d-flex-between mb-5">
					<h1 class="fw-bold heading"> @lang('What are clients say') </h1>
				</div>
			</div>
		</div>
		<div class="row">
...
@if ($reviews)
@foreach ($reviews as $key => $reviews_data)
	<div class="testimonial">
						<div class="bg-grey">
						    <div class="test-info">
						      <img class="test-pic" src="{{ asset('assets/images') }}/{{ $reviews_data->photo }}" alt="">
						      <div class="test-name">
						        <span>{{ $reviews_data->title }}</span>
						       {{ $reviews_data->subtitle }}
						      </div>
						    </div>

						    <p>
						      {{ $reviews_data->details }}
						    </p>
						</div>
					</div>
@endforeach
...
<section class="brand pt-0">
	<div class="container">
		 <div class="row">
			<div class="col-md-12">
				<div class="heading d-flex-between mb-5">
					<h1 class="fw-bold heading">@lang('Popular Brands')</h1>
				</div>
			</div>
		</div> 
		<div class="row">
...
@if ($partners)
@foreach ($partners as $key => $partners_data)
<div><img src="{{ asset('assets/images') }}/{{ $partners_data->photo }}" class="img-fluid"></div>
@endforeach
@endif
...
<div class="container" style="margin-bottom: 100px;">
    ...
    flex-wrap: wrap">
                @foreach ($locations as $key => $location)
					<div style="margin: 4px 7px 1px 3px">
						<a href="{{ route('front.listing',['category' => [$location->slug]]) }}" class="bg-round">@lang($location->name)|</a>
					</div>
					@endforeach
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <div class="d-flex align-items-center">
          ...
          <h4 class="modal-title fw-bold">@lang('More Categories')</h4>
        </div>
        <div>
      ...
      <div class="modal-body">
        <ul class="ps-0 style-none all-category" id="myUL">
            ...
            ?>
           @if ($categorieslimit)
                        @foreach ($categorieslimit as $key => $categorieslimits)
          ...
          <li>
            ...
            if ($subcategoriesCount == 0) {
            ?>
              <!--<a href="{{ route('front.subcat',['slug' => $categorieslimits->slug]) }}">-->
            <a href="{{ route('front.listing',['category'=>[$categorieslimits->slug]]) }}">
            <?php }else{ ?>   
            <a href="{{ route('front.subcat',['slug' => $categorieslimits->slug]) }}">
            <?php } ?>     
            
            <img class="me-2" src="{{ asset('assets/images') }}/{{ $categorieslimits->photo }}" style="width: 30px;">
            <p class="mb-0">@lang($categorieslimits->title)</p>
          </a></li>
          @endforeach
	    		@endif
