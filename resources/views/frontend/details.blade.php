            ...
            <div class="Rego-lkp-flex d-flex align-items-start justify-content-start">
                <div class="Rego-lkp-caption ps-3">
                    ...
                    <div class="d-block mt-1">
                        <div class="list-lioe">
                            <div class="list-lioe-single">
                                <span class="btn text-light rounded full-width theme-bg ft-medium" style="background: green !important;">{{ $data->openClose($data->id) }}</span>
                            </div>
                    ...
                    <div class="d-block mt-1">
                        <div class="list-lioe">
                            <div class="list-lioe-single">
                                <span class="btn text-light rounded full-width theme-bg ft-medium">{{ $data->openClose($data->id) }}</span>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mt-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <span class="text-white bg-success p-2 rounded-2">Rating {{ceil($data->directoryRatting($data->id))}}</span>
                                ...
                                <div class="Rego-rating">
                                    <div class="Rego-rates">
                                       ...
                                       ?>
                                        ...
                                        @for($i=1; $i<=ceil($data->directoryRatting($data->id)); $i++)
                                            <i class="fas fa-star active"></i>
                                        @endfor

                                        @for($i=1; $i<=(5-ceil($data->directoryRatting($data->id))); $i++)
                        ...
                        @endif
                                        ...
                                        <div class="d-block">
                                            <ul class="ps-0 d-flex adrs">
                                                <li class="me-2" style="font-size: 17px"><a href="#"><i class="ri-map-pin-line"></i>@lang($data->real_address)</a></li>
                                        ...
                                        <!--@endphp</p>-->
                                            <ul class="ps-0 d-flex btn-type">
                                                <li style="background: #339d3a;border: solid 1px#027c0a;"><a href="#" style="color:white;"><i class="ri-phone-line"></i> {{ $ps->phone }}</a></li>
                                                <li><a href="https://api.whatsapp.com/send?phone={{ $ps->phone }}&text=Hello"><i class="ri-whatsapp-line"></i> <b>Whatsapp</b></a></li>
                                                <li><a href="#"><i class="ri-share-forward-fill"></i> <b>Share</b></a></li>
                                                <li><a href="#"><i class="ri-pencil-fill"></i> <b>Edit</b></a></li>
                                                 <li><a href="{{ route('front.plans') }}"><i class="ri-verified-badge-line"></i> <b>Claim</b></a></li>
                    ...
                    @if (count($data->faqs)>0)
                        <div class="d-block mb-2">
                            <div class="jbd-01 py-2">
                                <div class="jbd-details">
                                    <h5 class="ft-bold fs-lg" style="padding: 0 0 0 18px">@lang('Frequently Asked Questions')</h5>
