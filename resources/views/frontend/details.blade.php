    ...
    <div class="Rego-ops-bhri">
        <div class="Rego-lkp-flex d-flex align-items-start justify-content-start">
            <div class="Rego-lkp-caption ps-3">
                <div class="Rego-lkp-title">
                    <h1 class="text-light mb-0 ft-bold">{{ $data->name }}</h4>
                </div>
                ...
                <div class="d-block mt-1">
                    <div class="list-lioe">
                        <div class="list-lioe-single">
                            <span class="btn text-light rounded full-width theme-bg ft-medium"
                                style="background: green !important;">{{ $data->openClose($data->id) }}</span>
                        </div>
...
<section class="gray py-5 position-relative">
                            ...
                            <div class="jbd-details">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mt-3">
                                            <div class="mb-3">
                                                <h5 class="ft-bold fs-lg">{{ $data->name }}
                                                    <!--<span class="verify"><i class="ri-checkbox-circle-fill text-success"></i> Verified</span>-->
                                                </h5>
                                            </div>
                                            <div class="mb-3">
                                                <span class="text-white bg-success p-2 rounded-2">Rating
                                                    {{ceil($data->directoryRatting($data->id))}}</span>
                                       ...
                                       ?>
                                                            ...
                                                            @for($i=1; $i<=ceil($data->directoryRatting($data->id));
                                                                $i++)
                                                                <i class="fas fa-star active"></i>
                                                                @endfor

                                                                @for($i=1; $i<=(5-ceil($data->
                                                                    directoryRatting($data->id))); $i++)
    ...
    font-size: 14px;">{{ count($data->reviews) }} @lang('Reviews')</span>
                                                    </div>
                                ...
                                <div class="d-block">
                                    <ul class="ps-0 d-flex adrs">
                                        <li class="me-2" style="font-size: 17px"><a href="#"><i
                                                    class="ri-map-pin-line"></i>@lang($data->real_address)</a></li>
                                        <!--<li class="me-2"><a href="#"><i class="ri-time-line"></i> <span class="text-success">{{ $data->openClose($data->id) }}</span></a></li>-->
                                        <li><a href="#"></a></li>
                                    </ul>
                                    <!--    <p>@php-->
                                    ...
                                    <ul class="ps-0 d-flex btn-type">
                                        <li style="background: #339d3a;border: solid 1px#027c0a;"><a href="#"
                                                style="color:white;"><i class="ri-phone-line"></i> {{ $ps->phone }}</a>
                                        </li>
                                        <li><a href="https://api.whatsapp.com/send?phone={{ $ps->phone }}&text=Hello"><i
                                                    class="ri-whatsapp-line"></i> <b>Whatsapp</b></a></li>
                                        <li><a href="#"><i class="ri-share-forward-fill"></i> <b>Share</b></a></li>
                                        <li><a href="#"><i class="ri-pencil-fill"></i> <b>Edit</b></a></li>
                                        <li><a href="{{ route('front.plans') }}"><i class="ri-verified-badge-line"></i>
                                                <b>Claim</b></a></li>
            ...
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="Rego-sng-menu">
                                            <div class="Rego-sng-menu-thumb">
                                                <img src="{{ asset('assets/images/'.$menu->menu_photo) }}"
                                                    class="img-fluid" alt="" />
                                            </div>
                                            <div class="Rego-sng-menu-caption">
                                                <h4 class="ft-medium fs-md">{{ $menu->menu_title}}</h4>
                                                <div class="lkji-oiyt"><span>@lang('Start From')</span>
                                                    <h5 class="theme-cl ft-bold">{{ showSignAmount($menu->menu_price) }}
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="d-block mt-3">
                                <div class="row g-3">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="Rego-sng-menu">
                                            <div class="Rego-sng-menu-thumb">
                                                <img src="{{ asset('assets/images/'.$room->room_photo) }}"
                                                    class="img-fluid" alt="" />
                                            </div>
                                            <div class="Rego-sng-menu-caption">
                                                ...
                                                <div class="lkji-oiyt mt-3"><span>@lang('Start From')</span>
                                                    <h5 class="theme-cl ft-bold">{{ showSignAmount($room->room_price) }}
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="d-block mt-3">
                                <div class="row g-3">
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class="Rego-sng-menu">
                                            <div class="Rego-sng-menu-thumb">
                                                <img src="{{ asset('assets/images/'.$service->service_photo) }}"
                                                    class="img-fluid" alt="" />
                                            </div>
                                            <div class="Rego-sng-menu-caption">
                                                <h4 class="ft-medium fs-md">{{ $service->service_name}}</h4>
                                                <p>@lang('Availability '): {{ $service->service_from }} - {{
                                                    $service->service_to }}</p>
                                                <p>@lang('Duration '): {{ $service->service_duration }} @lang('Minute')
                                                </p>
                                                <div class="lkji-oiyt"><span>@lang('Start From')</span>
                                                    <h5 class="theme-cl ft-bold">{{
                                                        showSignAmount($service->service_price) }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="d-block mb-2">
                    <div class="jbd-01 py-2">
                        <div class="jbd-details">
                            <h5 class="ft-bold fs-lg" style="padding: 0 0 0 18px">@lang('Frequently Asked Questions')
                            </h5>
                                        ...
                                        <div class="card-header" id="h{{$key}}">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link" data-bs-toggle="collapse"
                                                    data-bs-target="#ord{{$key}}" aria-expanded="true"
                                                    aria-controls="ord{{$key}}">
                                                    {{ $faq->faq_name}}
                                                </button>
                                            </h5>
                                        </div>

                                        <div id="ord{{$key}}" class="collapse {{ $key == 0 ? 'show' :''}}"
                                            aria-labelledby="h{{$key}}" data-parent="#accordion2">
                                            <div class="card-body">
                                                {{ $faq->faq_details}}
                                            </div>
                                        </div>
                            ...
                            <div class="reviews-comments-wrap">
                                ...
                                <div class="reviews-comments-item" style="padding: 0 0 25px 0px;">
                                    <div class="review-comments-avatar">
                                        @if ($review->user)
                                        <img src="{{ asset('assets/images/'.$review->user->photo)}}" class="img-fluid"
                                            alt="">
                                        @endif
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $schedules['mon_open'] }} - {{ $schedules['mon_close'] }}
                                                    </td>
                                                    @else
                                                    <td>@lang('closed')</td>
                                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $schedules['tue_open'] }} - {{ $schedules['tue_close'] }}
                                                    </td>
                                                    @else
                                                    <td>@lang('closed')</td>
                                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $schedules['wed_open'] }} - {{ $schedules['wed_close'] }}
                                                    </td>
                                                    @else
                                                    <td>@lang('closed')</td>
                                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $schedules['thu_open'] }} - {{ $schedules['thu_close'] }}
                                                    </td>
                                                    @else
                                                    <td>@lang('closed')</td>
                                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $schedules['fri_open'] }} - {{ $schedules['fri_close'] }}
                                                    </td>
                                                    @else
                                                    <td>@lang('closed')</td>
                                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $schedules['sat_open'] }} - {{ $schedules['sat_close'] }}
                                                    </td>
                                                    @else
                                                    <td>@lang('closed')</td>
                                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $schedules['sun_open'] }} - {{ $schedules['sun_close'] }}
                                                    </td>
                                                    @else
                                                    <td>@lang('closed')</td>
                                                    @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control rounded ht-140" name="message"
                                                    placeholder="@lang('Review')"></textarea>
                                            </div>
                                        </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="list-uiyt">
                                    ...
                                    <div class="list-uiyt-capt">
                                        <h5>@lang('Get Directions')</h5>
                                        <p>{{ $data->real_address }}</p>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="Rego-grid-wrap">
                    <div class="Rego-grid-upper">
                        ...
                        <div class="Rego-grid-thumb">
                            <a href="{{ route('front.listing.details',$data->slug) }}"
                    ...
                    <div class="Rego-grid-fl-wrap">
                        <div class="Rego-caption px-3 py-2">
                            <div class="Rego-author">
                                ...
                                <a href="{{ route('front.author.details','admin') }}">
                                    <img src="{{ asset('assets/images/'.getAdmin()->photo)}}" class="img-fluid circle"
                                        alt="">
                                </a>
                                @else
                                <a href="{{ route('front.author.details',$data->user->name) }}">
                                    <img src="{{ asset('assets/images/'.$data->user->photo)}}" class="img-fluid circle"
                                        alt="">
                                </a>
                                @endif
                            </div>
                            ...
                            <div class="Rego-middle-caption mt-3">
                                <p>
                                    {{ strlen($data->description)>60 ? substr($data->description,0,60) :
                                    $data->description }}
                                </p>
                            </div>
                        </div>
                        <div class="Rego-grid-footer py-2 px-3">
                            <div class="Rego-ft-first">
                                <a href="{{ route('front.listing',['category' => $data->category->slug]) }}"
                                    class="Rego-cats-wrap"><span class="cats-title">{{ $data->category->title
                                        }}</span></a>
                            </div>
                            <div class="Rego-ft-last">
                                <div class="Rego-inline">
                                    <div class="Rego-bookmark-btn"><button type="button"><i
                                                class="lni lni-envelope position-absolute"></i></button></div>
                                    <div class="Rego-bookmark-btn">
                                        <button type="button" class="wishList" data-listing="{{ $data->id }}"
                                            data-user={{ auth()->id() }}>
                                            <i
