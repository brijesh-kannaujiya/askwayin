                            ...
                            <div class="search-inner">
                                ...
                                <div class="side-filter-box">
                                    <div class="side-filter-box-body">
                                            ...
                                            <ul class="no-ul-list filter-list">
                                                @foreach ($categories as $key => $category)
                                                    <li>
                                                        ...
                                                        <label for="cat{{$key}}" class="checkbox-custom-label">@lang($category->title)</label>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="no-ul-list filter-list">
                                                @foreach ($locations as $key => $location)
                                                    <li>
                                                        ...
                                                        <label for="loc{{$key}}" class="checkbox-custom-label">@lang($location->name)</label>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        ...
                                        <div class="inner_widget_link">
                                            <h6 class="ft-medium">@lang('Filter')</h6>
                                            <ul class="no-ul-list filter-list">
                                                
                                                    <li>
                                                        <input id="" class="checkbox-custom search_loc" value="" type="checkbox">
                                                        <label for="" class="checkbox-custom-label">Top Rated</label>
                                                    </li>
                                                     <li>
                                                        <input id="" class="checkbox-custom search_loc" value="" type="checkbox">
                                                        <label for="" class="checkbox-custom-label">Trending</label>
                                                    </li>
                                                     <li>
                                                        <input id="" class="checkbox-custom search_loc" value="" type="checkbox">
                                                        <label for="" class="checkbox-custom-label">Ratings</label>
                                                    </li>
                                                    <li>
                                                        <input id="" class="checkbox-custom search_loc" value="" type="checkbox">
                                                        <label for="" class="checkbox-custom-label">verified</label>
                                                    </li>
                                                    <li>
                                                        <input id="" class="checkbox-custom search_loc" value="" type="checkbox">
                                                        <label for="" class="checkbox-custom-label">Trusted</label>
                                                    </li>
