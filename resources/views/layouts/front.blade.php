...
<head>
  ...
  {{-- @dd(0); --}}
  {{-- @dd(asset('/public/abc/front/css/styles.css')); --}}
...
?>
  ...
  <head>
    ...
    <link href="{{asset('assets/front/css/arabic_styles.css')}}" rel="stylesheet">
...
?>
      ...
      <!-- filter gallery -->
      <link rel="stylesheet" type="text/css" href="{{ asset('assets/front/css/gallery-filter.css') }}">
  ...
  <body>
    ...
    <!-- for slick slider -->
    <script type="text/javascript" src="{{ asset('assets/front/slick/slick.min.js') }}"></script>
