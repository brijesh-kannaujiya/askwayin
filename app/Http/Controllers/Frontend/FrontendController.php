...
class FrontendController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['categories'] = Category::whereIsTop(1)
            ->whereStatus(1)
            ->orderBy('id', 'ASC')->limit(23)
            ->get();

        $data['categorieslimit'] = Category::whereIsTop(0)
            ->whereStatus(1)
        ...
        $data['lang_ar'] = DB::table('languages')->where('is_default', 1)->where('rtl', 0)->get();
    ...
    public function advertise_with_us()
    {
        ...
        return view('frontend.advertisewithus', $data);
    ...
    public function advertise_with_us_email(Request $request)
    {
