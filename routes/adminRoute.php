...
use App\Http\Controllers\Admin\AppaddsController;
use App\Http\Controllers\Admin\BartnerController;
use App\Http\Controllers\Admin\SartnerController;
use App\Http\Controllers\Admin\HomeBannerAdvertisementController;
...
use App\Http\Controllers\Admin\UserSubscriberController;
...
Route::prefix('admin')->group(function(){
    ...
    Route::get('/cache/clear', function() {
     ...
     Route::group(['middleware'=>'permissions:Foodtype'],function(){
        Route::get('/foodtype/datatables', [FoodtypeController::class,'datatables'])->name('admin.foodtype.datatables');
        Route::get('/foodtype', [FoodtypeController::class,'index'])->name('admin.foodtype.index');
        Route::get('/foodtype/create', [FoodtypeController::class,'create'])->name('admin.foodtype.create');
        Route::get('/foodtype/edit/{id}', [FoodtypeController::class,'edit'])->name('admin.foodtype.edit');
        Route::post('/foodtype/store', [FoodtypeController::class,'store'])->name('admin.foodtype.store');
        Route::get('/foodtype/status/{id1}/{id2}', [FoodtypeController::class,'status'])->name('admin.foodtype.status');
        Route::post('/foodtype/update/{id}', [FoodtypeController::class,'update'])->name('admin.foodtype.update');
        Route::get('/foodtype/delete/{id}', [FoodtypeController::class,'destroy'])->name('admin.foodtype.delete');
        Route::get('/foodtype/bulk-delete', [FoodtypeController::class,'bulkdelete'])->name('admin.foodtype.bulk.delete');
     });
    ...
    //Route::get('/advertisewithus', [AdvertiseWithUsController::class,'index'])->name('admin.advertisewithus.index');
    Route::get('/advertisewithus-enquiry', [AdvertiseWithUsController::class,'index'])->name('admin.advertisewithus');
    Route::get('/advertisewithus-enquiry/delete/{id}', [AdvertiseWithUsController::class,'destroy'])->name('admin.advertisewithus.delete');
    Route::get('/advertisewithus-enquiry/bulk-delete', [AdvertiseWithUsController::class,'bulkdelete'])->name('admin.advertisewithus.bulk.delete');
      ...
      Route::group(['middleware'=>'permissions:Manage User'],function(){
      ...
      Route::group(['middleware'=>'permissions:Manage Subscriber'],function(){
          
        Route::get('/SubscriberUser/bonus', 'Admin\BonusController@index')->name('admin.SubscriberUser.bonus');
        Route::post('/SubscriberUser/edit/', 'Admin\BonusController@update')->name('admin.SubscriberUser.update');

        Route::get('/SubscriberUser/datatables', [UserSubscriberController::class,'datatables'])->name('admin-SubscriberUser-datatables');
        Route::get('/SubscriberUser', [UserSubscriberController::class,'index'])->name('admin.SubscriberUser.index');
        Route::get('/SubscriberUser/edit/{id}', [UserSubscriberController::class,'edit'])->name('admin-SubscriberUser-edit');
        Route::post('/SubscriberUser/edit/{id}', [UserSubscriberController::class,'update'])->name('admin-SubscriberUser-update');
        Route::get('/SubscriberUser/delete/{id}', [UserSubscriberController::class,'destroy'])->name('admin-SubscriberUser-delete');
        Route::get('/SubscriberUser/{id}/show', [UserSubscriberController::class,'show'])->name('admin-SubscriberUser-show');
        Route::get('/SubscriberUser/ban/{id1}/{id2}', [UserSubscriberController::class,'ban'])->name('admin-SubscriberUser-ban');
        Route::get('/SubscriberUser/default/image', [UserSubscriberController::class,'image'])->name('admin-SubscriberUser-image');
        Route::get('/SubscriberUser/deposit/{id}', [UserSubscriberController::class,'deposit'])->name('admin-SubscriberUser-deposit');
        Route::post('/SubscriberUser/deposit/{id}', [UserSubscriberController::class,'depositUpdate'])->name('admin-SubscriberUser-deposit-update');
        Route::post('/SubscriberUser/balance/add/deduct', [UserSubscriberController::class,'adddeduct'])->name('admin.SubscriberUser.balance.add.deduct');
      ...
      Route::group(['middleware'=>'permissions:Home Page Manage'],function(){
        ...
        Route::get('/appadds/datatables', [AppaddsController::class,'datatables'])->name('admin.appadds.datatables');
        Route::get('/appadds', [AppaddsController::class,'index'])->name('admin.appadds.index');
        Route::get('/appadds/create', [AppaddsController::class,'create'])->name('admin.appadds.create');
        Route::get('/appadds/edit/{id}', [AppaddsController::class,'edit'])->name('admin.appadds.edit');
        Route::post('/appadds/store', [AppaddsController::class,'store'])->name('admin.appadds.store');
        Route::post('/appadds/edit/{id}', [AppaddsController::class,'update'])->name('admin.appadds.update');
        Route::get('/appadds/delete/{id}', [AppaddsController::class,'destroy'])->name('admin.appadds.delete');
        
        
        

         Route::get('/bartner/datatables', [BartnerController::class,'datatables'])->name('admin.bartner.datatables');
        Route::get('/bartner', [BartnerController::class,'index'])->name('admin.bartner.index');
        Route::get('/bartner/create', [BartnerController::class,'create'])->name('admin.bartner.create');
        Route::get('/bartner/edit/{id}', [BartnerController::class,'edit'])->name('admin.bartner.edit');
        Route::post('/bartner/store', [BartnerController::class,'store'])->name('admin.bartner.store');
        Route::post('/bartner/edit/{id}', [BartnerController::class,'update'])->name('admin.bartner.update');
        Route::get('/bartner/delete/{id}', [BartnerController::class,'destroy'])->name('admin.bartner.delete');
        
         Route::get('/sartner/datatables', [SartnerController::class,'datatables'])->name('admin.sartner.datatables');
        Route::get('/sartner', [SartnerController::class,'index'])->name('admin.sartner.index');
        Route::get('/sartner/create', [SartnerController::class,'create'])->name('admin.sartner.create');
        Route::get('/sartner/edit/{id}', [SartnerController::class,'edit'])->name('admin.sartner.edit');
        Route::post('/sartner/store', [SartnerController::class,'store'])->name('admin.sartner.store');
        Route::post('/sartner/edit/{id}', [SartnerController::class,'update'])->name('admin.sartner.update');
        Route::get('/sartner/delete/{id}', [SartnerController::class,'destroy'])->name('admin.sartner.delete');


       Route::get('/home_banner_advertisement/datatables', [HomeBannerAdvertisementController::class,'datatables'])->name('admin.home_banner_advertisement.datatables');
        Route::get('/home_banner_advertisement', [HomeBannerAdvertisementController::class,'index'])->name('admin.home_banner_advertisement.index');
        Route::get('/home_banner_advertisement/create', [HomeBannerAdvertisementController::class,'create'])->name('admin.home_banner_advertisement.create');
        Route::get('/home_banner_advertisement/edit/{id}', [HomeBannerAdvertisementController::class,'edit'])->name('admin.home_banner_advertisement.edit');
        Route::post('/home_banner_advertisement/store', [HomeBannerAdvertisementController::class,'store'])->name('admin.home_banner_advertisement.store');
        Route::post('/home_banner_advertisement/edit/{id}', [HomeBannerAdvertisementController::class,'update'])->name('admin.home_banner_advertisement.update');
        Route::get('/home_banner_advertisement/delete/{id}', [HomeBannerAdvertisementController::class,'destroy'])->name('admin.home_banner_advertisement.delete');
