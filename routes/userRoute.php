...
Route::prefix('user')->group(function() {
    ...
    //Route::get('/test', [UserLoginController::class,'showTest'])->name('user.login');
    ...
    Route::group(['middleware' => ['otp','banuser']],function () {
      ...
      /////// Raies   ///////////////
      //Route::post('/subscription/telr-submit', [SubTelrController::class,'store'])->name('subscription.telr.submit');
     // Route::get('/subscription/telr/deposit/notify', [SubTelrController::class,'notify'])->name('subscription.telr.notify');
     // Route::get('/subscription/telr/deposit/cancel', [SubTelrController::class,'cancel'])->name('subscription.telr.cancel');
      /////// Raies   ///////////////
