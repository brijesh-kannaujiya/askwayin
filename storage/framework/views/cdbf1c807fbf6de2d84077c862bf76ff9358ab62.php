                                                ...
                                                <div class="dashboard-list-wraps-body py-3 px-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                         ...
                                                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                <label class="mb-1"><?php echo app('translator')->get('Map Link'); ?></label>
                                                                <input type="text" class="form-control rounded" name="gmap_address" placeholder="<?php echo e(__('Map Link')); ?>" value=""/>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="phone_number" class="form-control rounded" placeholder="<?php echo app('translator')->get('Phone number'); ?>" />
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/user/listing/create.blade.php ENDPATH**/ ?>