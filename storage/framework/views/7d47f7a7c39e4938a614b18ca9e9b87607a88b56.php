...
<?php if(Auth::guard('admin')->user()->sectionCheck('Home Banner')): ?>
<li class="nav-item">
    <a class="nav-link" href="<?php echo e(route('admin.transactions.index')); ?>">
        <i class="fas fa-chart-line"></i>
        <span><?php echo e(__('Home Banner')); ?></span>
    </a>
</li>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/includes/admin/roles/normal.blade.php ENDPATH**/ ?>