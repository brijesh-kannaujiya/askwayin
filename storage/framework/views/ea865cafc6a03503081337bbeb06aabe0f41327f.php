        ...
        <div class="Rego-search-shadow">
          <form class="main-search-wrap fl-wrap" action="#" method="GET">
            <div class="main-search-item">
              ...
              <input type="text" class="form-control radius" name="title" placeholder="What are you looking for?" />
            </div>
            <div class="main-search-item">
              <span class="search-tag">
                <i class="lni lni-map-marker"></i>
              </span>
              <input type="text" class="form-control" name="real_address" placeholder="UAE" />
            </div>
            <div class="main-search-item">
              <span class="search-tag">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/frontend/index.blade.php ENDPATH**/ ?>