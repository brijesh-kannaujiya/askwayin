                        ...
                        <div id="tabs">
                            ...
                            <div class="tab-content">
                                <div id="basic" class="container tab-pane active"><br>
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-lg-9">-->
                                    <!--        <input type="text" class="input-field" id="latitude" name="latitude"  placeholder="<?php echo e(__('Latitude')); ?>" value="" readonly>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-lg-9">-->
                                    <!--        <input type="text" class="input-field" id="longitude" name="longitude"  placeholder="<?php echo e(__('Longitude')); ?>" value="" readonly>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <select id="food_type" name="food_type" class="input-field">
                                                ...
                                                ?>
                                                <option value="<?php echo e($foodtype_data->id); ?>"><?php echo e(__($foodtype_data->name)); ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <select id="highlight_type" name="highlight_type" class="input-field">
                                                <option value="Tranding"><?php echo e(__('Tranding')); ?></option>
                                                <option value="Popular"><?php echo e(__('Popular')); ?></option>
                                                <option value="Verified"><?php echo e(__('Verified')); ?></option>
                                                <option value="Trusted"><?php echo e(__('Trusted')); ?></option>
                                                <option value="Top-rated"><?php echo e(__('Top-rated')); ?></option>
                                                <option value="Ads"><?php echo e(__('Ads')); ?></option>
                                                <option value="Deals"><?php echo e(__('Deals')); ?></option>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/admin/listing/create.blade.php ENDPATH**/ ?>