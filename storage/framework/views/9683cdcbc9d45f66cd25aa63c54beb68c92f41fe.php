					...
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-xl-11 col-lg-12 col-md-6 col-sm-12">
							<div class="abt_caption">
								<h2 class="ft-medium mb-4"><?php echo app('translator')->get($page->title); ?></h2>
								<p class="mb-4">
                                 
                                        <?php echo app('translator')->get($page->details); ?>;
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/frontend/page.blade.php ENDPATH**/ ?>