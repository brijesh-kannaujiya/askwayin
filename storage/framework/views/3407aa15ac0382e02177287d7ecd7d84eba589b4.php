...
<div class="row my-3">
    <?php 
$popularcat= DB::select('SELECT * FROM categories WHERE parent_id IS NULL ORDER by id DESC');
?>
...
<?php
$slug = $popularcat_data->slug;
$name = $popularcat_data->title;
?>
    <div class="col-xl-4 col-md-6 mb-4">
        <a href="<?php echo e(route('admin.listing.create',['type'=>"$slug"])); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/admin/listing/type.blade.php ENDPATH**/ ?>