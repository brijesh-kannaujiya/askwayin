        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="sec_title position-relative text-center">
                        <h2 class="off_title">Advertise With Us</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-start justify-content-center">
                ...
                <div class="col-xl-10 col-lg-11 col-md-12 col-sm-12">
                    <form class="row submit-form py-4 px-3 rounded bg-white mb-4" action="<?php echo e(route('front.advertisewithus.submit')); ?>" id="contactform">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/frontend/advertisewithus.blade.php ENDPATH**/ ?>