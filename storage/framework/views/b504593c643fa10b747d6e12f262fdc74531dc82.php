    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#manage_appads" aria-expanded="true" aria-controls="collapseTable">
            <i class="fab fa-telegram-plane"></i>
            <span><?php echo e(__('Manage App Adds')); ?></span>
        </a>
        <div id="manage_appads" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.appadds.index')); ?>"><?php echo e(__('All Appadds')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.appadds.create')); ?>"><?php echo e(__('Create Appadds')); ?></a>
            </div>
        </div>
    </li>
     ...
     <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#manage_ads" aria-expanded="true" aria-controls="collapseTable">
            <i class="fab fa-telegram-plane"></i>
            <span><?php echo e(__('Manage Ads')); ?></span>
        </a>
        <div id="manage_ads" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.plans.index')); ?>"><?php echo e(__('All Ads')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.plans.create')); ?>"><?php echo e(__('Create Ads')); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.foodtype.index')); ?>">
            <i class="fas fa-clinic-medical"></i>
            <span><?php echo e(__('FoodType')); ?></span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.user.index')); ?>">
            ...
            <span><?php echo e(__('Manage Users')); ?></span>
        </a>
    </li>
    
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.SubscriberUser.index')); ?>">
            <i class="fas fa-user"></i>
            <span><?php echo e(__('Manage Subscriber')); ?></span>
        </a>
    </li>
        ...
        <div id="homepage" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.partner.index')); ?>"><?php echo e(__('Partner Section')); ?></a>
                 <a class="collapse-item" href="<?php echo e(route('admin.bartner.index')); ?>"><?php echo e(__('Advertisement Banner')); ?></a>
                  <a class="collapse-item" href="<?php echo e(route('admin.sartner.index')); ?>"><?php echo e(__('Small Banner')); ?></a>
...
<?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/includes/admin/roles/super.blade.php ENDPATH**/ ?>