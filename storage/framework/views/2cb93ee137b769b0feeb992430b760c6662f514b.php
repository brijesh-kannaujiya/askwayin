                            ...
                            <div class="tab-content">
                                <div id="basic" class="container tab-pane active"><br>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="left-area">
                                                <h4 class="heading"><?php echo e(__('Map address.')); ?></h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                    ...
                                    <input type="text" class="form-control" id="latitude" name="latitude" value="<?php echo e($data->latitude); ?>" placeholder="Latitude" readonly />
                                    </div>
                                    </div>
                                    </div>
                                    ...
                                    <input type="text" class="form-control" id="longitude" name="longitude" value="<?php echo e($data->longitude); ?>" placeholder="Longitude" readonly />
                                    </div>
                                    </div>
                                    </div>
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-lg-9">-->
                                    <!--        <input type="text" class="input-field" name="latitude" placeholder="<?php echo e(__('Latitude')); ?>" value="<?php echo e($data->latitude); ?>" readonly style="background-color: #eaecf4;opacity: 1;"/>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-lg-9">-->
                                    <!--        <input type="text" class="input-field" name="longitude" placeholder="<?php echo e(__('Longitude')); ?>" value="<?php echo e($data->longitude); ?>" readonly style="background-color: #eaecf4;opacity: 1;"/>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <div class="row mt-3 is_top">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="form-check">
                                                <input type="checkbox" name="is_verify" class="form-check-input" value="1" id="is_verify" <?php echo e($data->is_verify == 1 ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="is_verify"><?php echo e(__('Check if this directory is Verify')); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-3 is_top">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="form-check">
                                                <input type="checkbox" name="is_toprated" class="form-check-input" value="1" id="is_toprated" <?php echo e($data->is_toprated == 1 ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="is_toprated"><?php echo e(__('Check if this directory is Top Rated')); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="left-area">
                                                <h4 class="heading"><?php echo e(__('Food Type')); ?> *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                            <select id="food_type" name="food_type" class="input-field">
                                                <?php
                                                $foodtype = DB::table('foodtypes')->where('status',1)->get();
                                                foreach($foodtype as $foodtype_data){
                                                ?>
                                                <option value="<?php echo e($foodtype_data->id); ?>" <?php echo e($data->id == $foodtype_data->id ? 'selected' : ''); ?>><?php echo e(__($foodtype_data->name)); ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="left-area">
                                                <h4 class="heading"><?php echo e(__('Highlights')); ?> *</h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-9">
                                            <select id="highlight_type" name="highlight_type" class="input-field">
                                                <option value="Tranding" <?php echo e($data->highlight_type == 'Tranding' ? 'selected' : ''); ?>><?php echo e(__('Tranding')); ?></option>
                                                <option value="Popular" <?php echo e($data->highlight_type == 'Popular' ? 'selected' : ''); ?>><?php echo e(__('Popular')); ?></option>
                                                <option value="Verified" <?php echo e($data->highlight_type == 'Verified' ? 'selected' : ''); ?>><?php echo e(__('Verified')); ?></option>
                                                <option value="Trusted" <?php echo e($data->highlight_type == 'Trusted' ? 'selected' : ''); ?>><?php echo e(__('Trusted')); ?></option>
                                                <option value="Top-rated" <?php echo e($data->highlight_type == 'Top-rated' ? 'selected' : ''); ?>><?php echo e(__('Top-rated')); ?></option>
                                                <option value="Ads" <?php echo e($data->highlight_type == 'Ads' ? 'selected' : ''); ?>><?php echo e(__('Ads')); ?></option>
                                                <option value="Deals" <?php echo e($data->highlight_type == 'Deals' ? 'selected' : ''); ?>><?php echo e(__('Deals')); ?></option>
                                            </select>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/admin/listing/edit.blade.php ENDPATH**/ ?>