        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                    ...
                    <form id="" class="subscription-form" action="<?php echo e(route('checkout.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <p><b>Note :</b> We are not accepting payments or any transaction from Iran, Cuba, North Korea, Sudan, Ukraine, Syria, Russian Federation and Yemen</p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/frontend/plan_details.blade.php ENDPATH**/ ?>