<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('SubscriberUser List')); ?></h5>
        <ol class="breadcrumb py-0 m-0">
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>

            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.SubscriberUser.index')); ?>"><?php echo e(__('SubscriberUser List')); ?></a></li>
        </ol>
        </div>
    </div>
...
<script type="text/javascript">
    'use strict';
        ...
        var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               searching: true,
               ajax: '<?php echo e(route('admin-SubscriberUser-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/admin/SubscriberUser/index.blade.php ENDPATH**/ ?>