    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="<?php echo e(route('admin.categories.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" name="pop_home_cat" class="form-check-input" value="1" id="pop_home_cat">
                    <label class="form-check-label" for="pop_cat"><?php echo e(__('Check if Home category is Popular')); ?></label>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/admin/categories/create.blade.php ENDPATH**/ ?>