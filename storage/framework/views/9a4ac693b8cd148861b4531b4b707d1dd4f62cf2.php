    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="<?php echo e(route('admin.categories.update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label><?php echo e(__('Category thumbnail2')); ?> </label>
                <div class="wrapper-image-preview">
                    <div class="box">
                        <div class="back-preview-image" style="background-image: url(<?php echo e($data->photo1 ? asset('assets/images/'.$data->photo1) : asset('assets/images/placeholder.jpg')); ?>);"></div>
                        <div class="upload-options">
                            <label class="img-upload-label" for="img-upload1"> <i class="fas fa-camera"></i> <?php echo e(__('Upload Picture')); ?> </label>
            ...
            <div class="form-group">
                <label><?php echo e(__('Category Banner')); ?> </label>
                <div class="wrapper-image-preview">
                    <div class="box">
                        <div class="back-preview-image" style="background-image: url(<?php echo e($data->photo_banner ? asset('assets/images/'.$data->photo_banner) : asset('assets/images/placeholder.jpg')); ?>);"></div>
                        <div class="upload-options">
            ...
            <div class="form-group">
                <label><?php echo e(__('App Image')); ?> </label>
                <div class="wrapper-image-preview">
                    <div class="box">
                        <div class="back-preview-image" style="background-image: url(<?php echo e($data->photo3 ? asset('assets/images/'.$data->photo3) : asset('assets/images/placeholder.jpg')); ?>);"></div>
                        <div class="upload-options">
                            <label class="img-upload-label" for="img-upload3"> <i class="fas fa-camera"></i> <?php echo e(__('Upload Picture')); ?> </label>
            ...
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" name="pop_cat" class="form-check-input" value="1" id="pop_cat" <?php echo e($data->pop_cat == 1 ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="pop_cat"><?php echo e(__('Check if this category is Popular')); ?></label>
                </div>
            </div>
            
            <div class="form-group">
                <div class="form-check">
                    <input type="checkbox" name="pop_home_cat" class="form-check-input" value="1" id="pop_home_cat" <?php echo e($data->pop_home_cat == 1 ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="pop_home_cat"><?php echo e(__('Check if Home category is Popular')); ?></label>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>