                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        ...
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <form action="#">
                                ...
                                <button type="submit" class="btn btn-secondary btn-lg btn-block">Declined</button>
                            </form>
                        </div>
                </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856343279/domains/askwayin.com/public_html/project/resources/views/decline.blade.php ENDPATH**/ ?>